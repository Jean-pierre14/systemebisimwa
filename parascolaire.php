                        ...
                        <div id="results" class="d-block">
                            <div class="">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item py-3 d-flex justify-content-between align-items-center list-group-item-action">
                                        First item
                                        <span class="btn-group">
                                            <button class="btn btn-sm btn-danger" type="button" id="non">Non</button>
